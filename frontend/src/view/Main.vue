          ...
          <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="service-item text-center pt-3">
              <div class="p-4">
                ...
                <p>
                  Khóa học sale, bán hàng sẽ giúp bạn hiểu và thực hành hiệu quả
                  những tuyệt chiêu trong bán hàng
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="service-item text-center pt-3">
              <div class="p-4">
                ...
                <h5 class="mb-3">Tin học văn phòng</h5>
                <p>
                  Thành thục kỹ năng tin học văn phòng cơ bản như Word, Excel,
                  Powerpoint
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="service-item text-center pt-3">
              <div class="p-4">
                ...
                <h5 class="mb-3">Ngoại ngữ</h5>
                <p>
                  Cung cấp các khóa học tiếng Anh, tiếng Hàn, tiếng Nhật và
                  tiếng Trung.
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
            <div class="service-item text-center pt-3">
              <div class="p-4">
                ...
                <h5 class="mb-3">Phát triển bản thân</h5>
                <p>
                  Hoàn thiện bản thân để gặt hái được nhiều thành công trong
                  cuộc sống
                </p>
              </div>
            </div>
        ...
        <div class="row g-4">
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="team-item bg-light">
              ...
              <div class="text-center p-4">
                <h5 class="mb-0">Phạm Thành Long</h5>
                <small>Luật sư - Diễn giả</small>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="team-item bg-light">
              ...
              <div class="text-center p-4">
                <h5 class="mb-0">TS Lê Thẩm Dương</h5>
                <small>Tiến sĩ - Diễn giả</small>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="team-item bg-light">
              ...
              <div class="text-center p-4">
                <h5 class="mb-0">Thái Vân Linh</h5>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
            <div class="team-item bg-light">
              ...
              <div class="text-center p-4">
                <h5 class="mb-0">Nguyễn Phùng Phong</h5>
                <small>Siêu trí tuệ</small>
              </div>
            </div>
          </div>
        </div>
