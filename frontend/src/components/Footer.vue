      ...
      <div class="container py-5">
        <div class="row g-5">
          <div class="col-lg-4 col-md-6">
            ...
            <a class="btn btn-link" href="">Điều khoản và dịch vụ</a>
          </div>
          <div class="col-lg-4 col-md-6">
            <h4 class="text-white mb-3">Liên hệ</h4>
            <p class="mb-2">
              <i class="fa fa-map-marker-alt me-3"></i>01 Đại Cồ Việt
            </p>
            <p class="mb-2">
          ...
          <div class="col-lg-4 col-md-6">
            <h4 class="text-white mb-3">Mail</h4>
            <p>Để lại mail để hỗ trợ</p>
